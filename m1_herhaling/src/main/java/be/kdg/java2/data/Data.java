...
public class Data {
    public static List<Monster> getData() {
        ...
        monsters.add(new Monster("Oni hitokuchi", 6.3, 5,MonsterType.water,LocalDate.of(2011, 7 ,20), 7));
        monsters.add(new Monster("Mumashika", 5.1, 5,MonsterType.air,LocalDate.of(2020, 3, 30),10));
        monsters.add(new Monster("Urashima Taro", 5.6, 5,MonsterType.earth,LocalDate.of(2021, 12,14), 25));
        return monsters;
    }
